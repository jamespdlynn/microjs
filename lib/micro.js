        ...
        if (typeof name !== 'string'){
            ...
            try{
                ...
                if (serializeType && (typeId%1 > 0 || typeId < 0 || typeId > 255)){
                    throw new Error("invalid typeId '"+typeId+"' (must be an integer between 0-255");
                }
            ...
            try{
                switch (type){
                    ...
                    case "object":
                        ...
                        if (!property.schema){
                            throw new Error("object schema has not been registered.");
                        }
                ...
                throw new Error("while writing schema property '" +property.name+"':  "+ e.message)
            }
